...
const string strMessageMagic = "EmaratCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EmaratCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1522189532, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Timestamp update on Mar 28 2018";
        CTransaction txNew;
        txNew.nTime = 1522189532;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1522189532;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1932447 : 1932447;
        ...
        assert(block.hashMerkleRoot == uint256("0x5bf70161b5aa1869a8488bfcfc66b770d8218d08bb99c97a73e430a7a71aa660"));
...
unsigned char pchMessageStart[4] = { 0xda, 0x05, 0x2b, 0xa0 };
